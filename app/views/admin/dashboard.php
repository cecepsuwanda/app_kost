            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3 mb-2">
                        <a href="/admin/penghuni" class="btn btn-outline-primary w-100">
                            <i class="bi bi-person-plus"></i><br>
                            Tambah Penghuni
                        </a>
                    </div>
                    <div class="col-md-3 mb-2">
                        <a href="/admin/kamar" class="btn btn-outline-success w-100">
                            <i class="bi bi-door-open"></i><br>
                            Kelola Kamar
                        </a>
                    </div>
                    <div class="col-md-3 mb-2">
                        <form method="POST" action="/admin/tagihan" class="w-100">
                ...
                <?php else: ?>
                    ...
                    <?php if (count($kamarKosong) > 5): ?>
                        <div class="text-center">
                            <a href="/admin/kamar" class="btn btn-sm btn-outline-success">
            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    ...
                    <?php if (count($kamarMendekatiJatuhTempo) > 5): ?>
                        <div class="text-center">
                            <a href="/admin/tagihan" class="btn btn-sm btn-outline-warning">
            ...
            <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach (array_slice($tagihanTerlambat, 0, 10) as $tagihan): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/admin/pembayaran?tagihan=<?= $tagihan['id'] ?>" class="btn btn-sm btn-primary">
                ...
                <?php if (count($tagihanTerlambat) > 10): ?>
                    <div class="text-center mt-3">
                        <a href="/admin/pembayaran" class="btn btn-outline-danger">
